...
main (void)
{
	...
	mu_assert_str_eq ("Test Value", pcmp_range16 (s1, sizeof s1 - 1, rA_Z, sizeof rA_Z));
	mu_assert_str_eq ("Test Value", pcmp_range (s2, sizeof s2 - 1, rA_Z, sizeof rA_Z));
	mu_assert_str_eq ("Test Value", pcmp_range16 (s2, sizeof s2 - 1, rA_Z, sizeof rA_Z));
	...
	mu_assert_ptr_eq (NULL, pcmp_range16 (s1, sizeof s1 - 1, r0_9, sizeof r0_9));
	mu_assert_ptr_eq (NULL, pcmp_range (s2, sizeof s2 - 1, r0_9, sizeof r0_9));
	mu_assert_ptr_eq (NULL, pcmp_range16 (s2, sizeof s2 - 1, r0_9, sizeof r0_9));
	mu_assert_ptr_eq (NULL, pcmp_range (s1, 0, rA_Z, sizeof rA_Z));
	mu_assert_ptr_eq (NULL, pcmp_range16 (s1, 0, rA_Z, sizeof rA_Z));
